...
class FastSurferExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'FastSurferCNNPlans',
        ...
        self.UNet_blocks_per_stage_encoder = (4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4)
        self.UNet_blocks_per_stage_decoder = (4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4)
        self.UNet_min_batch_size = 2
        self.UNet_max_features_2d = 64
    ...
    def static_estimate_VRAM_usage(patch_size: Tuple[int],
        ...
        net = UNet_class(input_channels=num_input_channels,
                         n_stages=n_stages,
                         ...
                         n_conv_per_stage_decoder=blocks_per_stage_decoder,
                         norm_op=norm_op)
    ...
    def get_plans_for_configuration(self,
        ...
        estimate = self.static_estimate_VRAM_usage(tuple(patch_size),
                                                   ...
                                                   tuple([min(self.UNet_max_features_2d if len(patch_size) == 2 else
                                                              ...
                                                              self.UNet_reference_com_nfeatures) for
                                                          _ in range(len(pool_op_kernel_sizes))]),
